	...
	public static int compteurID2(String[] listID) {
        ...
        for (String id : listID) {
            ...
            for (char lettre : id.toCharArray()) {//Je parcours chaque lettre de l'identifiant 
                collectionID.put(lettre, collectionID.getOrDefault(lettre, 0) + 1); //J'incrémente le compteur de la lettre dans le dictionnaire si elle existe et si elle n'existe pas elle prend la valeur 0 par défaut et l'incrémente
            }
